define(function (require) {
    ...
    var template 				= require('text!app/view/DangkiDonVi/tpl/model.html'),
	...
	return Gonrin.ModelView.extend({
		...
		button_duyet: function () {
			...
			self.$el.find(".button_duyet").unbind("click").bind("click",function() {
				var url =  self.getApp().serviceURL +"/api/v1/createDonvi";
				...
				$.ajax({
					...
					success: function (obj,data) {
						...
						self.model.save(null,{
							success: function (model, respose, options) {
								self.getApp().notify("Duyệt đơn vị thông tin thành công!");
