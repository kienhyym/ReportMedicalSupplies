define(function (require) {
    ...
    var template 			= require('text!app/view/DonViYTe/UserDonVi/tpl/model.html'),
	...
	// var TrinhdohocvanSelectView 	= require("app/view/DanhMuc/TrinhDoHocVan/SelectView");
    	...
    	render: function(){
			...
			if (curUser) {
				...
				if(dataview!==undefined && dataview!==null){
					...
					self.model.set("madonvi_bmte", self.getApp().currentUser.madonvi_bmte);
					self.model.set("donvi_id", self.getApp().currentUser.id);
					self.$el.find(".button_xoa").hide();
