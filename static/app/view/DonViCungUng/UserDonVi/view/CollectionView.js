define(function (require) {
	...
	var template = require('text!app/view/DonViCungUng/UserDonVi/tpl/collection.html'),
		schema = require('json!app/view/DonViCungUng/UserDonVi/schema/UserSchema.json');
