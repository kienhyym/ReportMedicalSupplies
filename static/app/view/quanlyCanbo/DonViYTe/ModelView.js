define(function(require) {
    ...
    return Gonrin.ModelView.extend({
        ...
        tools: [{
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    visible: function() {
                        return (this.getApp().hasRole('admin_tyt') === true || this.getApp().hasRole('admin') === true || this.getApp().hasRole('admin_benhvien') === true);
                    },
                    command: function() {
                        var self = this;
                        ...
                        self.model.set("unsigned_name", gonrinApp().convert_khongdau(name));

                        self.model.save(null, {
                            success: function(model, respose, options) {
                                self.getApp().notify("Lưu thành công!");
        ...
        render: function() {
            ...
            if (self.getApp().hasRole('canbo_tyt') == true || self.getApp().hasRole('canbo_benhvien') == true) {
            ...
            if (donvi_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        self.$el.find("#tuyendonvi").attr("readonly", true);
        ...
        getUserDonVi: function() {
            ...
            if (self.getApp().hasRole('admin_donvi') === false && self.getApp().hasRole('admin') === false) {
                ...
                $.ajax({
                    url: url_donvi,
                    method: "GET",
                    data: { "q": JSON.stringify({ "filters": { "organization_id": { "$eq": madonvi } }, "page": 1 }), "results_per_page": 2000 },
                    contentType: "application/json",
                    success: function(data) {
                        console.log(data);
                        $("#grid").grid({
