...
apimanager.create_api(User,
    ...
    url_prefix='/api/v1',
    preprocess=dict(GET_SINGLE=[validate_user], GET_MANY=[validate_user], POST=[validate_admin,preprocess_create_user], PUT_SINGLE=[validate_user,change_profile_user], DELETE_SINGLE=[validate_admin]),
