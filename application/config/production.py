class Config(object):
    ...
    DOMAIN_URL = 'https://bacsixa.vn'
    
    
    BUCKET_NAME = "bacsixa"
    FS_ROOT= "/opt/deploys/baocaotrangthietbiyte/repo/static/files/uploads/"
    FS_ROOT_FILE= "/opt/deploys/baocaotrangthietbiyte/repo/static/files/uploads/"
